            ...
            <d-form v-on:submit.prevent="handleAddParticipant">
              ...
              <d-form-row>
                <d-col md="6" class="form-group">
                  ...
                  <!-- <country-selector v-model="participantCountry" v-on:input="console.log(participantCountry)" required/> -->
                  <d-select name="pais" v-model="participantCountry">
                ...
                <d-col md="6">
                  ...
                  <d-input type="number" placeholder="Balance de cuenta" v-bind:state="participantAccountBalanceStante" v-model="participantAccountBalance" value="0" readonly/>  
                  <d-form-invalid-feedback v-if="participantAccountBalanceStante === 'invalid'">Por favor escriba un número de unidades válido</d-form-invalid-feedback>                  
                </d-col> 
              </d-form-row>
    ...
    methods: {
      ...
      writeOnBlockchain() {
        ...
        axios.post(endPoint, this.payLoad, this.$hyperledgerApiConfig).then((res) => {
          ...
          alert('El ' + this.participantTypeEs + ' NO se ha agregado. Inténtelo de nuevo');
        });
