...
export default {
  ...
  computed: {
    chartData: function () {
      let borderColor = 'rgba(193,58,80,1)';
      let backgroundColor = 'rgba(193,58,80,0.1)';
      let pointHoverBackgroundColor = 'rgb(193,58,80)';
      ...
      if (this.title === 'Humedad Relativa (%)'){
        borderColor = 'rgba(188,196,82,1)';
        backgroundColor = 'rgba(188,196,82,0.1)';
        pointHoverBackgroundColor = 'rgb(188,196,82)'
      }

      if (this.title === 'Luminosidad (lumen)'){
        borderColor = 'rgba(216,145,45,1)';
        backgroundColor = 'rgba(216,145,45,0.1)';
        pointHoverBackgroundColor = 'rgb(216,145,45)'
      }
      
      if (this.title === 'Humedad del Suelo (%)'){
        borderColor = 'rgba(178,219,76,1)';
        backgroundColor = 'rgba(178,219,76,0.1)';
        pointHoverBackgroundColor = 'rgb(178,219,76)'
      }      
  ...
  mounted() {
    ...
    const chartMeta = SensorChart.getDatasetMeta(0);
